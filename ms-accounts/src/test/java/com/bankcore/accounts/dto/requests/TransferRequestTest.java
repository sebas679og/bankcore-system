...
public class TransferRequestTest {
  ...
  void whenValidPin_thenNoViolations() {
    TransferRequest request = TransferRequest.builder().pin("1234").build();
  ...
  void whenNullPin_thenHasViolations() {
    TransferRequest request = TransferRequest.builder().pin(null).build();
  ...
  void whenEmptyPin_thenHasViolations(String pin) {
    TransferRequest request = TransferRequest.builder().pin(pin).build();
