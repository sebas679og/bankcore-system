...
public class TransactionRequestTest {
  ...
  void whenValidPin_thenNoViolations() {
    TransactionRequest request = TransactionRequest.builder().pin("1234").build();

    Set<ConstraintViolation<TransactionRequest>> violations =
        validator.validateProperty(request, "pin");
  ...
  void whenNullPin_thenHasViolations() {
    TransactionRequest request = TransactionRequest.builder().pin(null).build();
  ...
  void whenEmptyPin_thenHasViolations(String pin) {
    TransactionRequest request = TransactionRequest.builder().pin(pin).build();
